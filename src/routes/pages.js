...
res.render("index", { userId: req.session.userId, slots: slots || [], placements: map });
});


pages.get("/login", (_req, res) => res.render("login"));
pages.get("/register", (_req, res) => res.render("register"));
